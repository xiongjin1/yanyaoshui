...
function render(){
  ...
  $('alerts').innerHTML=(selected>=GLASS_START&&selected<='2026-09-03'?'<div class="alert">💡 <span><strong>思然已用完：</strong>按教材改用玻璃酸钠滴眼液，每天 4 次。</span></div>':'')+(selected>='2026-09-05'?'<div class="alert rose">⚠️ <span><strong>贝特舒需确认：</strong>教材只写“使用 ≥20 天”。9 月 6 日满 20 天，之后请按医生个体医嘱，不要根据本网页自行停药。</span></div>':'');
